...
def test_union():
    p = Polygon([(0, 0, 1), (0, 1, 1), (1, 1, 1), (1, 0, 1), (0, 0, 1)])
    p2 = Polygon([(-1, -1, 10), (-1, 1, 10), (1, 1, 10), (1, -1, 10), (-1, -1, 10)])

    resWkt = p.union(p2).wktDecim(2)

    g1 = sfcgal.read_wkt(resWkt)
    g2 = sfcgal.read_wkt('POLYGON((0.00 1.00,-1.00 1.00,-1.00 -1.00,1.00 -1.00,1.00 0.00,1.00 1.00,0.00 1.00))')
...
def test_union_3d():
    ...
    g1 = sfcgal.read_wkt(resWkt)
    g2 = sfcgal.read_wkt('GEOMETRYCOLLECTION(TIN(((-0.00 0.00 1.00,-0.00 1.00 1.00,1.00 1.00 1.00,-0.00 0.00 1.00)),((1.00 -0.00 1.00,-0.00 0.00 1.00,1.00 1.00 1.00,1.00 -0.00 1.00))),TIN(((-1.00 -1.00 10.00,-1.00 1.00 10.00,1.00 1.00 10.00,-1.00 -1.00 10.00)),((1.00 -1.00 10.00,-1.00 -1.00 10.00,1.00 1.00 10.00,1.00 -1.00 10.00))))')
